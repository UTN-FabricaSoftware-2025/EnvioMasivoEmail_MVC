Feature: Filtrado de correos en LeerCorreosDesdeTxt
  ...
  Scenario Outline: Normalización y filtrado por regex
    ...
    Examples: Casos de prueba
      ...
      | simple@test.com;ad min@empresa.org; allunav@utn.edu.ec        | allunav@utn.edu.ec,simple@test.com       | Caso base: Todos validos. Removemos el espacio erróneo en simple@.    |
